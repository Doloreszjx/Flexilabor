...
export default function Messages() {
	...
	return (
		<div className='bg-blue-50 min-h-screen'>
			<Header />
			{loggedUser && (
				<div className='flex flex-col lg:flex-row gap-6 container py-8 px-4 sm:px-8 max-w-screen-xl mx-auto'>
...
function ChatMessage({ message }) {
	...
	return (
		<div
			className={`flex items-center mb-4 p-2 rounded-lg max-w-xs ${messageClass}`}
		>
			<Image
